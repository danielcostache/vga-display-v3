...
namespace eval ::optrace {
  variable script "C:/Work/VGA Display/vga-display-v3/project/vga-display.runs/impl_1/toplevel.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet {{C:/Work/VGA Display/vga-display-v3/project/vga-display.runs/synth_1/toplevel.dcp}}
